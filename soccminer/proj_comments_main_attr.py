...
class EntityLevelComment:
    ...
    def get_package_level_comments(self):
        comment_list = []
        for comment in self.package_level_comment_list:
...
class EntityLevelComprehensiveComment(EntityLevelComment):
    ...
    def get_comprehensive_package_comment_attr(self):
        return self.package_level_comment_list
